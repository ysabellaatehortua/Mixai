...
def main():
    importedCocktails, importedIngredients, importedRecipes = importAllDrinksMain()
    allRecipes = makeRecipes(importedCocktails, importedRecipes)
    writeToFile(allRecipes, importedIngredients)


def writeToFile(allRecipes, ingredients):
    ...
    for ingredient in ingredients:
        ...
        if ingredient[3]:
            ...
            ABV = "null"
        stringToWrite = name + "  type: " + type + "  Alcohol?: " + alcohol + "  ABV: " + ABV
